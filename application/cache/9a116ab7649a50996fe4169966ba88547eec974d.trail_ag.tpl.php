...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_514564e70db97',
  'has_nocache_code' => false,
  'cache_lifetime' => 1,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_514564e70db97')) {function content_514564e70db97($_smarty_tpl) {?>  <!--
		...
		<div id="main-wrapper" style="width: 700px">
			<div style="margin: 0 auto; text-align: center">
				...
				<table id="table" style="text-align: left; color: black">
					...
					<tbody>
						<tr>
							<td><a href="http://localhost/lalaines/audit_trail/trail_ledger/index?acc_no=8&from=1-10-12&to=12-10-12">Sales</a></td>
							<td></td>
							<td>7850.00</td>
						</tr>
					</tbody>
