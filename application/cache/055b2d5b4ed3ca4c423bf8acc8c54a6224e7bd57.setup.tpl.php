...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_514973beb399d',
  'has_nocache_code' => false,
  'cache_lifetime' => 1,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_514973beb399d')) {function content_514973beb399d($_smarty_tpl) {?><!--
	...
	<body>
		...
		<div id="main-wrapper-setup">
			<div id="form-container">
				<form id="setup" class="form-horizontal" method="post" action="http://localhost/trailblazer/setup/saveUserInfo">
					<h4>User Info</h4>
