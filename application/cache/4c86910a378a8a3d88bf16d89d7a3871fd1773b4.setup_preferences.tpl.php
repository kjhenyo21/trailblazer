...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_51497413dcef8',
  'has_nocache_code' => false,
  'cache_lifetime' => 1,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51497413dcef8')) {function content_51497413dcef8($_smarty_tpl) {?>  <!--
	...
	<body>
		...
		<div id="main-wrapper-setup">
			<div id="form-container">
				<form id="setup" class="form-horizontal" method="post" action="http://localhost/trailblazer/setup/savePreferences">
