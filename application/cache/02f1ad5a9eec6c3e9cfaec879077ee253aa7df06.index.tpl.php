...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_50c834c951642',
  'has_nocache_code' => false,
  'cache_lifetime' => 1,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50c834c951642')) {function content_50c834c951642($_smarty_tpl) {?>  <!--
	...
	<body>
		...
		<div id="searchCustomerForInvoice" class="modal hide fade" style="margin-top: auto; width: 480px">
			...
			<div class="modal-body">
				<form method="post" action="http://localhost/wadwe/cashier/index/searchCustomerInvoice">
					<fieldset>
		...
		<div class="navbar-inner">
			<div class="container">
				...
				<a class="brand" href="http://localhost/wadwe/cashier" style="color: white; margin-left: 30px; padding-right: 0px">Log out</a>
			</div>
		</div>
