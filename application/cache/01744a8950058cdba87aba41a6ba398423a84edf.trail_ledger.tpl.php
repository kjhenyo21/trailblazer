...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_514564ee6910e',
  'has_nocache_code' => false,
  'cache_lifetime' => 1,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_514564ee6910e')) {function content_514564ee6910e($_smarty_tpl) {?>  <!--
...
<!DOCTYPE html>
	...
	<body>
		...
		<div id="audit_trail" class="modal hide fade" style="margin-top: auto; width: 480px">
			...
			<div class="modal-body">
				<form method="post" action="http://localhost/lalaines/cashier/index/searchCustomerInvoice">
					<fieldset>
		...
		<div class="navbar-inner">
			<div class="container">
				...
				<a class="brand" href="http://localhost/lalaines/cashier" style="color: white; margin-left: 30px; padding-right: 0px">Log out</a>
			</div>
		</div>
			...
			<div style="margin: 0 auto; text-align: center">
				...
				<table id="table" style="text-align: left; color: black">
					...
					<tbody>
						<tr>
							<td>January 2012</td>
							<td><a href="http://localhost/lalaines/audit_trail/trail_transactions/index?from=018423500&to=018423628">018423500-018423628</a></td>
							<td></td>
							<td>290.00</td>
						</tr>
						<tr>
							<td>February 2012</td>
							<td><a href="http://localhost/lalaines/audit_trail/trail_transactions/index?from=018423628&to=018423753">018423628-018423753</a></td>
							<td></td>
							<td>380.00</td>
						</tr>
						<tr>
							<td>March 2012</td>
							<td><a href="http://localhost/lalaines/audit_trail/trail_transactions/index?from=018423753&to=018423884">018423753-018423884</a></td>
							<td></td>
							<td>400.25</td>
						</tr>
						<tr>
							<td>April 2012</td>
							<td><a href="http://localhost/lalaines/audit_trail/trail_transactions/index?from=018423884&to=018423972">018423884-018423972</a></td>
							<td></td>
							<td>634.55</td>
						</tr>
	...
	<script src="http://localhost/lalaines/assets/scripts/bootstrap-datepicker.js" type="text/javascript"></script>
	<script>
		$('#due_date').datepicker();
		var today = new Date();
