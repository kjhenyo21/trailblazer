...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_51445a8b1610c',
  'has_nocache_code' => false,
  'cache_lifetime' => 1,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51445a8b1610c')) {function content_51445a8b1610c($_smarty_tpl) {?><!--
...
-->
				...
				<form id="addItem">
					<fieldset>
						<div class="input-append" style="margin: 0 100px">
							...
							<input type="hidden" id="temp_inv_no" name="temp_inv_no" value="39021095">
		...
		<div id="main-wrapper">
			<form method="post" action="http://localhost/lalaines/cashier/invoice/placeInvoice" style="margin: 0 0">
				<fieldset>
					...
					<div class="form-inline">
						...
						<span>
							<label>TI No.</label>
							<input type="text" id="invoice_no" value="39021095" style="height: 11pt; width: 85px" readonly="readonly">
						</span>
					</div>
					<br>
					<div id="items">
						...
						<table style="color: black">
							<tr>
								<td style="width: 300px; vertical-align: top">
									<a href="#addModal" data-toggle="modal" data-inv_no="39021095">Add Item</a>
									<br><br><br><br>
								</td>
								<td style="width: 300px; vertical-align: top">
									<div class="form-inline">
					...
					<div>
						<input type="hidden" id="user_id" name="user_id" value="C-69241">
						...
						<a data-url="http://localhost/lalaines/cashier/invoice/reset?no=39021095" class="btn" type="button" id="cancel_inv" disabled="disabled">Reset Invoice</a>
						<a href="http://localhost/lalaines/cashier" class="btn" type="button" id="back">Back</a>
					</div>
				</fieldset>
			</form>
		</div>
